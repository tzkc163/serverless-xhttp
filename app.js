...
// 环境变量
const UUID = process.env.UUID || '918cf7af-fafe-4144-8ffb-abc66563639e'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'cangt.zdok.hf.space';                   // 域名或ip,留空将自动获取服务器ip
